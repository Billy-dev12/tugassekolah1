...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-nav mt-3">
            ...
            <a href="tiket.php" class="sidebar-item <?= basename($_SERVER['PHP_SELF']) == 'tiket.php' ? 'active' : '' ?>">
                <i class="fas fa-fw fa-ticket-alt"></i>
                <span>Tiket Servis</span>
            </a>
            <a href="riwayat.php" class="sidebar-item <?= basename($_SERVER['PHP_SELF']) == 'riwayat.php' ? 'active' : '' ?>">
                <i class="fas fa-fw fa-history"></i>
                <span>Riwayat</span>
            </a>
            <a href="profil.php" class="sidebar-item <?= basename($_SERVER['PHP_SELF']) == 'profil.php' ? 'active' : '' ?>">
                <i class="fas fa-fw fa-user"></i>
                <span>Profil Saya</span>
            </a>
            <div class="sidebar-item mt-4">
                <i class="fas fa-fw fa-sign-out-alt"></i>
                <a href="../autentikasi/logout.php"><span>Logout</span></a>
            </div>
        </div>
    </div>
